...
{
    [LuisModel("990640bf-46d5-4a4a-9238-c37c2f742ffe", "43dc198a9e954e05bb94103643151b42")]
    [Serializable]
    public class SimpleLUISDialog : LuisDialog<object>
    {
        ...
        [LuisIntent("Swear")]
        public async Task Swear(IDialogContext context, LuisResult result)
        {
            await context.PostAsync("Please don't swear");
            context.Wait(MessageReceived);
        }
